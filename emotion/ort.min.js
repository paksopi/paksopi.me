...
var ort = (() => {
  ...
  var Ws = me(Vs => {
    ...
    for (vt = 0; vt < 64; )
      zs[
        (Cr[vt] = vt < 26 ? vt + 65 : vt < 52 ? vt + 71 : vt < 62 ? vt - 4 : (vt - 59) | 43)
      ] = vt++;
    var vt;
      ...
      for (var n = null, s = [], i = 0, u; o < e; )
        (u = t[o++]),
          u < 128
            ...
            : u > 239 && u < 365
            ? ((u =
                (((u & 7) << 18) | ((t[o++] & 63) << 12) | ((t[o++] & 63) << 6) | (t[o++] & 63)) -
                65536),
              (s[i++] = 55296 + (u >> 10)),
              (s[i++] = 56320 + (u & 1023)))
  ...
  var fi = me(($y, pu) => {
    ...
    se.prototype.uint32 = function (t) {
      return (
        (this.len += (this.tail = this.tail.next = new ui(
                  ...
                  (typeof e.irVersion == 'number'
                    ...
                    : (n.irVersion =
                        r.longs === String
                          ...
                          : r.longs === Number
                          ? new y.LongBits(e.irVersion.low >>> 0, e.irVersion.high >>> 0).toNumber()
                          : e.irVersion)),
                e.producerName != null &&
                  e.hasOwnProperty('producerName') &&
                  ...
                  return (
                    ...
                    r.end != null &&
                      (y.Long
                        ...
                        ? (n.end = r.end)
                        : typeof r.end == 'object' &&
                          (n.end = new y.LongBits(r.end.low >>> 0, r.end.high >>> 0).toNumber())),
                    n
                  );
                }),
          ...
          try {
            return (
              ...
              ce.verbose(
                ...
                }; textureCacheMode: ${this.textureCacheMode}; pack: ${this.pack}; async: ${
                  this.async
                }.`,
              ),
              !0
              ...
              for (; u < n.length; ) {
                ...
                ce.verbose(
                  ...
                  `Runing op:${p.node.name} (${T.map(
                    (I, L) => `'${p.node.inputs[L]}': ${I.type}[${I.dims.join(',')}]`,
                  ).join(', ')})`,
                );
        ...
        function (t = {}) {
          ...
          function vn(b, x, _, D) {
            ...
            var Zr = 'Sunday Monday Tuesday Wednesday Thursday Friday Saturday'.split(' '),
              Qr = 'January February March April May June July August September October November December'.split(
                ' ',
              );
            (Ue = {
  ...
  var la,
    ...
    ca = E(() => {
      ...
      (la = a => {
        ...
        (fa = a => [void 0, 4, 1, 1, 2, 2, 4, 8, void 0, 1, 2, 8, 4, 8, void 0, void 0, void 0][a]),
        (Xp = a => {
          switch (a) {
            case 'float16':
